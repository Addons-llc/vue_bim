...
const supplierDetails = computed(() => {
  ...
  return {
    ...selectedDetails,
    ...supplier,
    displayName: supplier.displayName || store?.name || selectedDetails.displayName || supplierName.value,
    storeName: store?.name || selectedDetails.storeName || '',
    supplier: supplier.supplier || store?.supplier || selectedDetails.supplier || '',
    image: supplier.image || store?.image || selectedDetails.image,
    bannerImage: supplier.bannerImage || store?.bannerImage || selectedDetails.bannerImage,
    phone: supplier.phone || store?.contactNumber || selectedDetails.phone,
    email: supplier.email || store?.email || selectedDetails.email,
    website: supplier.website || store?.website || selectedDetails.website,
    details: supplier.details || store?.description || store?.supplierDetails || selectedDetails.details,
    sellerSince: supplier.sellerSince || store?.sellerSince || selectedDetails.sellerSince,
